...
- Do not invent behavior or APIs for `eventsalsa/store`, `eventsalsa/projector`, or `eventsalsa/encryption`. If implementation details are unknown, leave a placeholder and keep claims neutral.
